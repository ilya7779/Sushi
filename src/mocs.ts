...
import { philadelphiaSalmon, philadelphiaWithSalmonLight, philadelphiaEel, philadelphiaShrimp,
  ...
  gunkanWithEel, gunkanWithTunaAndCucumber, gunkanWithShrimp, musselTempura, shrimpTempura } from "./assets";
...
export const classicalRolls = [
  ...
  { id: 3, poster: `${philadelphiaEel}`, title: 'Филадельфия с угрём',
    composition: 'Состав: рис, нори, сыр, авокадо, угорь', price:'27,9 GEL' },
  { id: 4, poster: `${philadelphiaShrimp}`, title: 'Филадельфия с креветками',
    composition: 'Состав: рис, нори, сыр, авокадо, креветки', price: '24,9 GEL' },
  ...
  { id: 7, poster: `${philadelphiaWithTuna}`, title: 'Филадельфия с тунцом',
    composition: 'Состав: рис, нори, тунец,сыр, авокадо, соус Унаги, кунжут', price: '29,9 GEL' },
  { id: 8, poster: `${californiaSalmon}`, title: 'Калифорния с лососем',
    composition: 'Состав: рис, нори, огурец, икра тобико, острый соус, лосось', price: '25,9 GEL' },
  { id: 9, poster: `${californiaEel}`, title: 'Калифорния с угрём',
    composition: 'Состав: рис, нори, огурец, икра тобико, острый соус, угорь', price: '29,9 GEL' },
  { id: 10, poster: `${californiaTuna}`, title: 'Калифорния с тунцом',
    composition: 'Состав: рис, нори, огурец, икра тобико, острый соус, тунец', price: '29,9 GEL' },
  { id: 11, poster: `${californiaWithShrimp}`, title: 'Калифорния с креветкой',
    composition: 'Состав: креветка, огурец, икра масаго, майонез', price: '26,9 GEL' },
  { id: 12, poster: `${vegan}`, title: 'Веганский',
    composition: 'Состав: рис, нори, огурец, авокадо, сладкий перец, смесь для салата', price: '19,9 GEL' },
  { id: 13, poster: `${musselMeat}`, title: 'С мясом мидий',
    composition: 'Состав: рис, нори, сыр, огурец, мясо мидий, острый соус', price: '23,9 GEL' },
  { id: 14, poster: `${crabRoll}`, title: 'Крабовый ролл',
    composition: 'Состав: рис, нори, огурец, соус унаги, острый соус, соус томаго, японский майонез, крабовые палочки',
    price: '20,9 GEL' },
  ...
  { id: 22, poster: `${canadaCheese}`, title: 'Канадский Чизу',
    composition: 'Состав: сыр, угорь, авокадо, лосось, икра тобико, соус унаги, кунжут', price: '30,9 GEL' },
...
export const tempuraRolls = [
  { id: 25, poster: `${tempuraRollWithShrimp}`, title: 'Тёплый ролл с креветкой',
    composition: 'Состав: рис, нори, сыр, огурец, креветка, соус унаги, острый соус, темпура', price: '27,9 GEL' },
  { id: 26, poster: `${tempuraRollWithSalmon}`, title: 'Тёплый ролл с лососем',
    composition: 'Состав: рис, нори, сыр, огурец, лосось, соус унаги, острый соус, темпура', price: '24,9 GEL' },
  { id: 27, poster: `${tempuraRollWithMusselMeat}`, title: 'Тёплый ролл с мясом мидий',
    composition: 'Состав: рис, сыр, огурец, мясо мидий, соус унаги, острый соус, темпура', price: '24,9 GEL' },
  { id: 28, poster: `${tempuraRollWithEel}`, title: 'Тёплый ролл с угрём',
    composition: 'Состав: рис, нори, сыр, огурец, угорь, соус унаги, острый соус, темпура', price: '29,9 GEL' },
  { id: 29, poster: `${tempuraRollWithCrabSticks}`, title: 'Тёплый ролл с крабовими палочками',
    composition: 'Состав: рис, нори, сыр, огурец, крабовые палочки, соус унаги, острый соус, темпура', price: '23,9 GEL' },
];
