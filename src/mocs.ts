...
import {
  philadelphiaSalmon,
  philadelphiaWithSalmonLight,
  philadelphiaEel,
  philadelphiaShrimp,
  philadelphiaWithSalmonAndShrimp,
  philadelphiaWithCheese,
  philadelphiaWithTuna,
  californiaSalmon,
  californiaEel,
  californiaTuna,
  californiaWithShrimp,
  vegan,
  musselMeat,
  crabRoll,
  bonitoSalmon,
  ...
  blackDragon,
  redDragon,
  tempuraRollWithShrimp,
  tempuraRollWithSalmon,
  tempuraRollWithMusselMeat,
  tempuraRollWithEel,
  tempuraRollWithCrabSticks,
  canadaCheese,
  hayashiRoll,
  friendShrimpInPanko,
  salmon,
  ...
  withShrimpTempura,
  veganSushi,
  gunkanWithSalmonAndAvocado,
  gunkanWithEel,
  gunkanWithTunaAndCucumber,
  gunkanWithShrimp,
  musselTempura,
  shrimpTempura,
  soupPhiladelphia,
  ...
  halal,
  carbonara,
  caesarSaladWithShrimps,
  caesarChicken,
  iceCreamAndBerries,
  adjarianKhachapuri,
  khachapuriMegruli,
  khachapuriImeruli,
  noImage, frenchFries, mexicanPotato, chickenWings, onionRings, goldDragon, jungleJuice
} from "./assets";
...
export const classicalRolls = [
  ...
  { id: 21, poster: `${goldDragon}`, title: 'Золотой дракон',
    composition: 'Состав: рис, нори, сыр, авокадо, креветка, сыр, икра тобико, соус унаги, кунжут', price: '29,9 GEL' },
...
export const snacks = [
  ...
  { id: 70, poster: `${frenchFries}`, title: 'Картофель фри',
    composition: 'Состав: картофель фри', price: '5 GEL' },
  { id: 71, poster: `${mexicanPotato}`, title: 'Картофель по-мексикански',
    composition: 'Состав: картофель по-мексикански', price: '6 GEL' },
  { id: 72, poster: `${chickenWings}`, title: 'Куриные крылышки',
    composition: 'Состав: куриные крылышки', price: '12 GEL' },
  { id: 73, poster: `${onionRings}`, title: 'Луковые кольца',
    composition: 'Состав: Луковые кольца', price: '8 GEL' },
];


export const pizzas = [
  { id: 59, poster: `${margarita}`, title: 'Маргарита',
    composition: 'Состав: моцарелла, томатный соус, помидор', price: '16 GEL' },
  { id: 60, poster: `${cezar}`, title: 'Цезарь',
    composition: 'Состав: куриная грудка, моцарелла, пармезан, листья салата, помидоры чери, соус цезарь', price: '18 GEL' },
  { id: 61, poster: `${pepperoni}`, title: 'Пеперони',
    composition: 'Состав: моцарелла, салями, томатный соус', price: '18 GEL' },
  { id: 62, poster: `${withProsciutto}`, title: 'С прошутто',
    composition: 'Состав: моцарелла, прошутто, руккола, томатный соус', price: '22 GEL' },
  { id: 63, poster: `${fourCheese}`, title: 'Четыре сыра',
    composition: 'Состав: моцарелла, эмменталь, Дор Блю, пармезан', price: '18 GEL' },
  { id: 64, poster: `${bavarian}`, title: 'Баварская',
    composition: 'Состав: колбаски копчёные, пеперони, сыр, маринованный огурец', price: '18 GEL' },
  { id: 65, poster: `${hawaiian}`, title: 'Гавайская',
    composition: 'Состав: томатный соус, сыр, ананасы, ветчина', price: '18 GEL' },
  { id: 66, poster: `${halal}`, title: 'Мясная',
    composition: 'Состав: мясной фарш, помидоры, сладкий перец, моцарелла', price: '18 GEL' },
  { id: 67, poster: `${carbonara}`, title: 'Карбонара',
    composition: 'Состав: бекон, моцарелла, яйцо, сливочный соус', price: '18 GEL' },
];

export const salads = [
  { id: 100, poster: `${caesarSaladWithShrimps}`, title: 'Цезарь с креветками',
    composition: '', price: '18 GEL' },
  { id: 101, poster: `${caesarChicken}`, title: 'Цезарь с курицей',
    composition: '', price: '14 GEL' },
  { id: 102, poster: `${saladWithChuka}`, title: 'Салат с чукой',
    composition: '', price: '11 GEL' },
...
export const vienneseWaffles = [
  { id: 106, poster: `${noImage}`, title: 'С шоколадом и орехами',
     composition: '', price: '10 GEL' },
  // { id: 107, poster: `${musselTempura}`, title: 'Со сгущёнкой и орехами',
  //   composition: '', price: '10 GEL' },
  { id: 108, poster: `${iceCreamAndBerries}`, title: 'Мороженое с ягодами',
    composition: '', price: '10 GEL' },
  { id: 109, poster: `${noImage}`, title: 'С яйцом пашот и соус Дор Блю',
    composition: '', price: '12 GEL' },
  { id: 110, poster: `${noImage}`, title: 'С лососем',
    composition: '', price: '16 GEL' },
];

export const khachapuris = [
  { id: 111, poster: `${adjarianKhachapuri}`, title: 'Хачапури по Аджарски',
    composition: '', price: '12 GEL' },
  { id: 112, poster: `${khachapuriMegruli}`, title: 'Хачапури Мегрули',
    composition: '', price: '14 GEL' },
  { id: 113, poster: `${khachapuriImeruli}`, title: 'Хачапури Имерули',
    composition: '', price: '12 GEL' },
];
export const soups = [
...
export const coffees = [
  ...
  { id: 113, title: 'Капучино', price: '4.5 GEL' },
  { id: 114, title: 'Латте', price: '5 GEL' },
  ...
  { id: 121, title: 'Американо с Baileys', price: '8.5 GEL' },
  { id: 122, title: 'Чай чёрный, зелёный, 600ml', price: '5 GEL' },
  { id: 123, title: 'Крафтовый чай', price: '8 GEL' },
  { id: 115, title: 'Молочный коктейль', price: '7 GEL' },
];

export const coldDrinks = [
  { id: 124, poster: '', title: 'Кола, Фанта 0.33', price: '3 GEL' },
  { id: 125, poster: '', title: 'Вода без газа 0.5', price: '3 GEL' },
  { id: 126, poster: '', title: 'Набеглави 0.5', price: '3 GEL' },
  { id: 127, poster: '', title: 'Red bull', price: '7 GEL' },
  { id: 128, poster: '', title: 'Натахтари(лимонад) 0.5', price: '3 GEL' },
  { id: 117, poster: '', title: 'Мохито', price: '5 GEL' },
];
...
export const otherAlcohols = [
  ...
  { id: 137, poster: '', title: "Виски Ballantine's 100ml", price: '11 GEL' },
  { id: 138, poster: '', title: 'Виски Jack Daniels 100ml', price: '21 GEL' },
  { id: 139, poster: '', title: 'Виски Jameson 100ml', price: '17 GEL' },
];

export const coctails = [
  { id: 140, poster: `${noImage}`, title: 'Jungle Juice',
    composition: 'gin, pisan, lemon fresh, orange juice', price: '12 GEL' },
  { id: 141, poster: `${noImage}`, title: 'Night Gin',
    composition: 'gin, lemon fresh, crema de classic', price: '11 GEL' },
  { id: 142, poster: `${noImage}`, title: 'Godfather',
    composition: 'whiskey, creme de cafe', price: '13 GEL' },
  { id: 143, poster: `${noImage}`, title: 'Aperol Spritz',
    composition: 'brut champagne, soda, aperol', price: '15 GEL' },
  { id: 144, poster: `${noImage}`, title: 'Tequila Sunrise',
    composition: 'tequila, grenadine, orange juice', price: '13 GEL' },
  { id: 145, poster: `${noImage}`, title: 'Pina Colada',
    composition: 'light rum, ice cream, coconut liqueur, pineapple juice', price: '15 GEL' },
  { id: 146, poster: `${noImage}`, title: 'Hawaii',
    composition: 'light rum, curacao blue, coconut liqueur, pineapple juice', price: '13 GEL' },
  { id: 147, poster: `${noImage}`, title: 'Long Island Ice Tea',
    composition: 'vodka, tequila, gin, cola, lemon juice, light rum, triple sec', price: '19 GEL' },
  { id: 148, poster: `${noImage}`, title: 'Blue Lagoon',
    composition: 'rum, sprite, curacao blue, lemon fresh', price: '15 GEL' },
  { id: 149, poster: `${noImage}`, title: 'Mohito',
    composition: 'rum, mint, lime, sprite', price: '15 GEL' },
  { id: 150, poster: `${noImage}`, title: 'Bahama mama',
    composition: 'liquor, coconut, light rum, pineapple juice, orange juice', price: '15 GEL' },
  { id: 151, poster: `${noImage}`, title: 'Tropical Dream',
...
export const beers = [
  ...
  { id: 158, title: 'Taati 0.5', price: '6 GEL' },
  { id: 159, title: 'Staropramen 0.5', price: '5 GEL' },
];
